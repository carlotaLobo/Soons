...
namespace Soons.DataService
{
    ...
    public class CartDataService
    {
        ...
        private PaginaPagoViewModel cartPageViewModel;
        ...
        /// </summary>
        public PaginaPagoViewModel PaginaPagoViewModel =>
            this.cartPageViewModel = PopulateData<PaginaPagoViewModel>("ecommerce.json");
