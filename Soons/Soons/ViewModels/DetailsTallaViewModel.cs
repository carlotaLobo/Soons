...
namespace Soons.ViewModels
{
    ...
    [DataContract]
    public class DetailsTallaViewModel : BaseViewModel
    {
        ...
        public DetailsTallaViewModel(ServiceSoons serviceSoons)
        {
            ServiceSoons = serviceSoons;
        }

        public async Task<Prod> ObtenerProductoPorSku(string codigo)
        {
            Prod producto = await this.ServiceSoons.ProductoBySKU(codigo);
            return producto;
        }

        public async Task<List<Stock>> ObtenerListadoStock(int id)
        {
            List<Stock> stock = await this.ServiceSoons.GetStockById(id);
            return stock;
        }
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="DetailsTallaViewModel"/> class.
        /// </summary>
        public DetailsTallaViewModel()
        {
        }
        #endregion
