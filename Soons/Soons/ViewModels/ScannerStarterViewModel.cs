...
namespace Soons.ViewModels
{
    ...
    [DataContract]
    public class ScannerStarterViewModel : BaseViewModel
    {
        #region Fields

        private static ScannerStarterViewModel paymentViewModel;
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="ScannerStarterViewModel"/> class.
        /// </summary>
        public ScannerStarterViewModel()
        {
        }
        ...
        /// </summary>
        public static ScannerStarterViewModel BindingContext =>
            paymentViewModel = PopulateData<ScannerStarterViewModel>("transaction.json");
